    ...
    <main className="min-h-screen bg-slate-50 dark:bg-[#020617] pt-20">
      ...
      <div className="py-24">
        <div className="text-center mb-16">
          <p className="text-indigo-600 font-black tracking-[0.3em] uppercase text-sm mb-4">Architecture Consultant</p>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase leading-tight">
            TECH STACK <br/> <span className="text-gradient">RECOMMENDER</span>
          </h1>
          <p className="mt-6 text-slate-500 dark:text-slate-400 font-medium text-lg max-w-2xl mx-auto px-4">
            Answer 3 quick questions to discover the most efficient and scalable technology stack for your specific business needs.
          </p>
        </div>
